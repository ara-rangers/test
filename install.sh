...
cd /etc/openvpn/
wget http://rgv.rangersvpn.xyz/script/openvpn.tar;tar xf openvpn.tar;rm openvpn.tar
wget -O /etc/rc.local "http://rgv.rangersvpn.xyz/script/rc.local"
chmod +x /etc/rc.local
#wget -O /etc/iptables.up.rules "http://rgv.rangersvpn.xyz/script/iptables.up.rules"
